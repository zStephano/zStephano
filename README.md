...
<p align="left">👨‍💻 With 5 years of experience as a Software Engineer, I’ve worked in startups, large corporations, and multinational companies, especially in the financial sector. Specializing in Back-End development, I have deep expertise in C#, using both .NET Framework 4.x and .NET (versions 5 to 9), focusing on high-performance, secure, resilient, scalable, and robust solutions.
I’ve worked on complex monolithic systems and microservices, where I developed BFFs in C# and TypeScript, APIs, and event-sourcing/event-driven services using RabbitMQ, SNS, and SQS. I’ve also integrated with external projects from companies such as Atlassian (Jira), Service Now, Blip, B3 (Clearing), Serasa, Clear Sale, Digibee, and Multiclubes.<br><br>🚀 I actively participated in technology migrations in legacy projects, both in C# and other languages (like PHP), converting functionalities into microservices and integrating BFFs as needed, ensuring efficiency, data security, and scalability. I’ve been involved in critical decision-making for projects and incidents, including refactoring, process discontinuation, and implementation of new services.<br><br>☁ I have experience with cloud infrastructure and cloud computing (Azure and AWS), creating VMs, serverless applications, and CI/CD pipelines for continuous development. I work with SQL Server, MySQL, and PostgreSQL (Aurora DB), using ORMs like Entity Framework and Dapper, as well as in-memory caching for performance optimization.
I’ve contributed significantly to code reviews via GitHub and Azure DevOps, ensuring the application of best practices such as SOLID, KISS, DRY, YAGNI, DDD, and Clean Code. I also leverage integrated AI tools (GitHub Copilot, Amazon Q) to boost productivity and code quality.<br><br>🛠 I have expertise in event-driven architectures, SOA, MVC, MVVM, monolithic and microservices architectures, with proficiency in containers (Docker) and application servers (IIS). I’ve developed skills in technical leadership and managing multidisciplinary teams, driving project success and optimizing development processes. I’ve also worked with application monitoring via Dynatrace, unit testing with xUnit, and test coverage using SonarQube, with a strong focus on software quality.</p><br>
